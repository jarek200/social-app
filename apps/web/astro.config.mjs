...
export default {
  ...
  vite: {
    define: {
      ...
      'import.meta.env.PUBLIC_AMPLIFY_ENV': JSON.stringify(process.env.PUBLIC_AMPLIFY_ENV || environment),
      ...
      'import.meta.env.PUBLIC_DEMO_MODE': JSON.stringify(process.env.PUBLIC_DEMO_MODE || 'false'),
    },
    resolve: {
      alias: {
